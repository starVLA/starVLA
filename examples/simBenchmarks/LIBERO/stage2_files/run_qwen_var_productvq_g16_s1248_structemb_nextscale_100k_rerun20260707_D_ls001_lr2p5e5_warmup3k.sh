...
RUN_ID="qwen_var_productvq_g16_s1248_structemb_nextscale_100k_rerun20260707_D_ls001_lr2p5e5_warmup3k"
CONFIG_YAML="examples/simBenchmarks/LIBERO/stage2_files/train_qwen_var_productvq_g16_s1248_structemb_nextscale_100k_rerun20260707_D_ls001_lr2p5e5_warmup3k.yaml"
...
[libero_stage2_rerun]
  ...
  main_process_port=${MAIN_PROCESS_PORT:-29545}
EOF
