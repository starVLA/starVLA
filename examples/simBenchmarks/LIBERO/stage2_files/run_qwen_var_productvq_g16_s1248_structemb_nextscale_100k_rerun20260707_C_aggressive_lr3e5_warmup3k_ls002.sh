...
RUN_ID="qwen_var_productvq_g16_s1248_structemb_nextscale_100k_rerun20260707_C_aggressive_lr3e5_warmup3k_ls002"
CONFIG_YAML="examples/simBenchmarks/LIBERO/stage2_files/train_qwen_var_productvq_g16_s1248_structemb_nextscale_100k_rerun20260707_C_aggressive_lr3e5_warmup3k_ls002.yaml"
...
[libero_stage2_rerun]
  ...
  main_process_port=${MAIN_PROCESS_PORT:-29544}
EOF
