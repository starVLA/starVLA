...
RUN_DIR="/root/nas/feihong/starVLA/Checkpoints/qwen_var_productvq_g16_s1248_structemb_nextscale_100k_fullcache"
mkdir -p "${RUN_DIR}"
...
"${PYTHON_BIN}" -m accelerate.commands.launch \
  ...
  --config_yaml examples/simBenchmarks/LIBERO/stage2_files/train_qwen_var_productvq_g16_s1248_structemb_nextscale_100k.yaml \
  2>&1 | tee -a "${LOG_FILE}"
