...
RUN_DIR="playground/Checkpoints/qwen_var_productvq_g16_s8_structemb_parallel_v2_stable_100k_fullcache"
mkdir -p "${RUN_DIR}"
...
/home/zhangfeihong/miniconda3/envs/starVLA/bin/accelerate launch \
  ...
  --config_yaml examples/simBenchmarks/LIBERO/stage2_files/train_qwen_var_productvq_g16_s8_structemb_parallel_v2_stable_100k.yaml \
  2>&1 | tee "${LOG_FILE}"
