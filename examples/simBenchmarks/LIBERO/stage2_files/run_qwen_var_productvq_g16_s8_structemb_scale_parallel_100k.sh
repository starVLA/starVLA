...
RUN_DIR="playground/Checkpoints/qwen_var_productvq_g16_s8_structemb_scale_parallel_100k_fullcache"
mkdir -p "${RUN_DIR}"
...
/home/zhangfeihong/miniconda3/envs/starVLA/bin/accelerate launch \
  ...
  --main_process_port "${MAIN_PROCESS_PORT:-29532}" \
  starVLA/training/train_starvla.py \
  --config_yaml examples/simBenchmarks/LIBERO/stage2_files/train_qwen_var_productvq_g16_s8_structemb_scale_parallel_100k.yaml \
  2>&1 | tee "${LOG_FILE}"
