...
RUN_DIR="/root/nas/feihong/starVLA/Checkpoints/qwen_var_productvq_g16_s1248_metaworld_mt50_100k_fullcache"
mkdir -p "${RUN_DIR}"
...
"${PYTHON_BIN}" -m accelerate.commands.launch \
  ...
  --main_process_port "${MAIN_PROCESS_PORT:-29548}" \
  starVLA/training/train_starvla.py \
  --config_yaml examples/simBenchmarks/MetaWorld/stage2_files/train_qwen_var_productvq_g16_s1248_metaworld_mt50_100k.yaml \
  2>&1 | tee -a "${LOG_FILE}"
