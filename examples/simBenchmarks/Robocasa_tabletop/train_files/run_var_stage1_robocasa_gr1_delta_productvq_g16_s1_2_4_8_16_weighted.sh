...
INIT_CKPT="/root/feihong/starVLA/Checkpoints/var_stage1_robocasa_gr1_delta_pure_ae_e128_weighted/best_recon.ckpt"
if [[ ! -f "${INIT_CKPT}" ]]; then
  echo "Missing delta pure AE init checkpoint: ${INIT_CKPT}" >&2
  exit 1
fi
