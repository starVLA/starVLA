...
export MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-29565}"
...
bash "examples/simBenchmarks/Robocasa_tabletop/stage2_files/run_qwen_var_productvq_g16_s124816_robocasa_best_recon_e128_100k_lr1e4_warmup5000_gbs1024.sh"
