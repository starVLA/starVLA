...
RUN_DIR="/root/nas/feihong/starVLA/Checkpoints/qwen_var_productvq_g16_s124816_robocasa_epoch027_100k_lr2p5e5_warmup3000_fullcache"
mkdir -p "${RUN_DIR}"
...
"${PYTHON_BIN}" -m accelerate.commands.launch \
  ...
  --config_yaml examples/simBenchmarks/Robocasa_tabletop/stage2_files/train_qwen_var_productvq_g16_s124816_robocasa_epoch027_100k_lr2p5e5_warmup3000.yaml \
  2>&1 | tee -a "${LOG_FILE}"
