...
RUN_DIR="/root/feihong/starVLA/qwen_var_productvq_g16_s124816_robocasa_best_recon_e128_100k_lr1e4_warmup5000_gbs512_fullcache"
mkdir -p "${RUN_DIR}"
...
"${PYTHON_BIN}" -m accelerate.commands.launch \
  ...
  --config_yaml examples/simBenchmarks/Robocasa_tabletop/stage2_files/train_qwen_var_productvq_g16_s124816_robocasa_best_recon_e128_100k_lr1e4_warmup5000_gbs512.yaml \
  2>&1 | tee -a "${LOG_FILE}"
