...
echo "  vla_arena_L0_S   – small split only"
echo "  vla_arena_L0_M   – medium split only"
echo "  vla_arena_L0_L   – large split only"
echo "  vla_arena_L0_all – all three splits combined"
