...
class LeRobotSingleDataset(Dataset):
    ...
    def get_state_or_action(
        ...
        # Pad the data #@JinhuiYE TODO rethining about pad transform
...
class LeRobotMixtureDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Per-dataset step order and cursor for sequential sampling
    ...
    def sample_step(self, index: int) -> tuple[LeRobotSingleDataset, int, int]:
        ...
        # Sample dataset
        dataset_index = rng.choice(len(self.datasets), p=self.dataset_sampling_weights) # reminder: dataset_bl
        ...
        # Sequential step sampling with shuffle on wrap
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        for attempt in range(max_retries):
            try:
                ...
                raw_data = dataset.get_step_data(trajectory_id, step)   # TODO make use of dataset._get_item_ 
